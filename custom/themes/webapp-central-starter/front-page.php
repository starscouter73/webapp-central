...
$cloud_connector_link = '';
$cloud_connector_page = get_page_by_path('system');
if ($cloud_connector_page instanceof WP_Post) {
    $cloud_connector_link = (string) get_permalink($cloud_connector_page);
}
?>
<main class="platform-home">
    <?php while (have_posts()) : the_post(); ?>
        ...
        <section class="platform-section platform-section--split cloud-status-section" id="cloud-connector-status">
            <div class="platform-panel cloud-status-panel">
                <span class="portal-badge"><?php esc_html_e('Cloud Connector', 'webapp-central-starter'); ?></span>
                <h2><?php esc_html_e('Safe-Mode Cloud-/Sync-System als sichtbarer Live-Baustein', 'webapp-central-starter'); ?></h2>
                <p><?php esc_html_e('Der aktuelle Gesamtstand bleibt auf der oeffentlichen Startseite als kompakte Statuskachel sichtbar, ohne als Overlay oder Admin-Komponente aufzutreten.', 'webapp-central-starter'); ?></p>
                <div class="cloud-status-badges" aria-label="<?php esc_attr_e('Cloud Connector Status', 'webapp-central-starter'); ?>">
                    <span class="cloud-status-badge is-safe"><?php esc_html_e('Safe-Mode', 'webapp-central-starter'); ?></span>
                    <span class="cloud-status-badge is-runtime"><?php esc_html_e('Runtime validiert', 'webapp-central-starter'); ?></span>
                    <span class="cloud-status-badge is-draft"><?php esc_html_e('Draft-PRs', 'webapp-central-starter'); ?></span>
                </div>
                <p class="cloud-status-note"><?php esc_html_e('Alle Datei- und Cloud-Aktionen bleiben aktuell im Safe-Mode oder Readonly-Modus. Keine produktiven Uploads, Downloads, Moves oder Deletes aktiv.', 'webapp-central-starter'); ?></p>
                <?php if ($cloud_connector_link !== '') : ?>
                    <div class="hero__actions">
                        <a class="button-link" href="<?php echo esc_url($cloud_connector_link); ?>">
                            <?php esc_html_e('Cloud Connector ansehen', 'webapp-central-starter'); ?>
                        </a>
                    </div>
                <?php endif; ?>
            </div>
            <aside class="cloud-status-card-wrap">
                <div class="platform-card cloud-status-card">
                    <span class="portal-badge portal-badge--soft"><?php esc_html_e('Live validiert / Safe-Mode aktiv', 'webapp-central-starter'); ?></span>
                    <strong><?php esc_html_e('Cloud Connector', 'webapp-central-starter'); ?></strong>
                    <p class="cloud-status-subline"><?php esc_html_e('Safe-Mode Cloud-/Sync-System', 'webapp-central-starter'); ?></p>
                    <ul class="cloud-status-list">
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Safe-Mode-Core', 'webapp-central-starter'); ?></span></li>
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Provider-UI', 'webapp-central-starter'); ?></span></li>
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Explorer', 'webapp-central-starter'); ?></span></li>
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Sync Preview', 'webapp-central-starter'); ?></span></li>
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Drag & Drop', 'webapp-central-starter'); ?></span></li>
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Readonly-Live vorbereitet', 'webapp-central-starter'); ?></span></li>
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Netzwerk-/Transfermap', 'webapp-central-starter'); ?></span></li>
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Architekturuebersicht', 'webapp-central-starter'); ?></span></li>
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Runtime-Tests', 'webapp-central-starter'); ?></span></li>
                        <li><span class="cloud-check" aria-hidden="true">&#10003;</span><span><?php esc_html_e('Deploy-Checklist', 'webapp-central-starter'); ?></span></li>
                    </ul>
                </div>
            </aside>
        </section>
